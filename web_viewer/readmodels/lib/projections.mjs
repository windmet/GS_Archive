...
export async function writeReadModels(root, release, product, provenance = {}) {
  ...
  for (const gasha of product.gashas) {
    ...
    gashaRows.push({ ...pick(gasha, ['id','code','primary_code','display_name','category','banner_url','start_at','end_at','phase','related_pickup_count']), detail: descriptor });
  }
  await directory('gashas', gashaRows, { searchRows: gashaRows });
