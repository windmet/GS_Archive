...
assert.match(stageManagerSource, /if \(this\._destroyed \|\| !this\.app \|\| options\.isCurrent\?\.\(\) === false\) return null/)
assert.match(stageManagerSource, /if \(this\._destroyed \|\| !this\.app \|\| this\._spawnTokens\[idolId\] !== spawnToken \|\| options\.isCurrent\?\.\(\) === false\)/)
