...
> 维护说明：本文是 2026-06-25 前端重构历史记录，不再作为当前开发入口。剧情预览器当前交接入口见 [STORY_VIEWER_NEXT_WINDOW_AUDIT_20260722.md](./STORY_VIEWER_NEXT_WINDOW_AUDIT_20260722.md)，Runtime 规范见 [STORY_VIEWER_RUNTIME_REFACTOR_DESIGN_20260718.md](./STORY_VIEWER_RUNTIME_REFACTOR_DESIGN_20260718.md)，本地化规范见 [STORY_LOCALIZATION_CONTRACT_20260719.md](./STORY_LOCALIZATION_CONTRACT_20260719.md)。
